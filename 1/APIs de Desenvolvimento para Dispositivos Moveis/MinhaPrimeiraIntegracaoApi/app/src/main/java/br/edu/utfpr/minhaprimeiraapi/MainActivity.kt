...
class MainActivity : AppCompatActivity() {
    ...
    private fun fetchItems() {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            val result =
                br.edu.utfpr.minhaprimeiraapi.service.safeApiCall { RetrofitClient.apiService.getItems() }
            ...
            withContext(Dispatchers.Main) {
                ...
                when (result) {
                    ...
                    is br.edu.utfpr.minhaprimeiraapi.service.Result.Success -> handleOnSuccess(result.data)
                }
            }
        }
    }
    ...
    private fun setupView() {
        ...
        binding.addCta.setOnClickListener {
            startActivity(br.edu.utfpr.minhaprimeiraapi.NewItemActivity.newIntent(this))
        }
    }
